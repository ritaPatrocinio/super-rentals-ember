...
module('Acceptance | super rentals', function (hooks) {
  ...
  test('visiting /', async function (assert) {
    ...
    const AboutUsButton = '.jumbo a.button';

    assert.dom(AboutUsButton).hasText('About Us');
    await click(AboutUsButton);
  ...
  test('visiting /rentals/grand-old-mansion', async function (assert) {
    ...
    assert.strictEqual(buttonURL.host, 'twitter.com');

    assert.strictEqual(
      buttonURL.searchParams.get('url'),
